...
[list]
[li]The free API on the Smush.it service will not accept files >2M in size, as such no size reduction on those files is possible with this addon[/li]
