...
### Important Notes
* The Smush.it free level service will not accept files >2M in size, as such no size reduction on those files is possible with this addon
